---
name: create-commit
description: Group changed files and create Conventional Commits (one commit per group). Use when the user asks to commit, create commits, or invokes create-commit.
---
# Create commit
