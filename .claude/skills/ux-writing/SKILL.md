...
description: >-
  ...
  success/warning/info messages, announcements, tooltips, CTAs, alt text, and
  placeholders — using Atlassian Design Content–adapted standards. Use when
  writing or editing UI strings, microcopy, UX writing, voice and tone,
